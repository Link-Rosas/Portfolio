...
function ryancv_ocdi_import_files() {
    ...
    return array(
        ...
        array(
            'import_file_name'             => 'ml-engineer',
            'categories'                   => array( esc_attr__( 'Main', 'ryancv' ) ),
            'import_file_url'              => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/ml-engineer/content.xml',
            'import_preview_image_url'     => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/ml-engineer/preview.jpg',
            'preview_url'                  => 'https://1.envato.market/c/1790164/275988/4415?u=https://themeforest.net/item/ryancv-vcard-resume-wordpress-theme/full_screen_preview/22890097',
        ),

        array(
            'import_file_name'             => 'project-manager',
            'categories'                   => array( esc_attr__( 'Main', 'ryancv' ) ),
            'import_file_url'              => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/project-manager/content.xml',
            'import_preview_image_url'     => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/project-manager/preview.jpg',
            'preview_url'                  => 'https://1.envato.market/c/1790164/275988/4415?u=https://themeforest.net/item/ryancv-vcard-resume-wordpress-theme/full_screen_preview/22890097',
        ),
