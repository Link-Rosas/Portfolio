...
<?php
	...
	if ($theme_style == 5) {
		$classes[] = 'body-style-gradient body-style-gradient-n gn-three';
	}
	if ($scroll_type) {
...
<?php if ( $menu_style == 4 ) : ?> menu-horizontal-style<?php endif; ?>
<?php if ( ! $switcher_ui ) : ?> switcher-ui-disabled<?php endif; ?>">

		<!-- Preloader -->
		<?php if ( $preloader_type == 'minimal' && $preloader_hide != 1 ) : ?>
		...
		<?php endif; ?>
		<div class="preloader<?php if ( $preloader_type == 'minimal' || $preloader_type == 'minimal-blur' ) : ?> loader-curve<?php endif; ?><?php if ( $preloader_hide == 1 ) : ?> is-disabled<?php endif; ?>">
			<?php if ( $preloader_type == 'minimal-blur' ) : ?><div class="preloader-blur"></div><?php endif; ?>
			<div class="centrize full-width">
				<div class="vertical-center">
					<?php if ( $preloader_type == 'minimal' || $preloader_type == 'minimal-blur' && $preloader_text ) : ?>
...
<?php if ( $vcard_layout == 3 ) : ?> layout-minimal-transparent-style<?php endif; ?>
...
<?php if ( $vcard_img_layout == 8 ) : ?> full-style-textured<?php endif; ?>" id="home-card">
				...
				<?php if ( !$switcher_ui & $sidebar_disable & ( $cart_disable || !class_exists( 'WooCommerce' ) ) ) : ?> brs-top<?php endif; ?>">
					<div class="profile-content">
						...
						<div class="slide" <?php if ( $vcard_bg ) : ?>style="background-image: url(<?php echo esc_url( $vcard_bg['url'] ); ?>);"<?php endif; ?>>
							<?php if ( $vcard_bg ) : ?><img src="<?php echo esc_url( $vcard_bg['url'] ); ?>" width="0" height="0" style="display: none;" fetchpriority="high" alt="" /><?php endif; ?>
