...
update_option( 'RyanCV_lic_Key', 'f090bd7d-1e27-4832-8355-b9dd45c9e9ca' );
update_option( 'RyanCV_lic_email', 'halo@weadown.com' );
...
function ryancv_stylesheets() {
	...
	wp_enqueue_style( 'ryancv-animate', get_template_directory_uri() . '/assets/css/animate.css', '1.0' );
	...
	if ( class_exists( 'WooCommerce' ) ) {
		wp_enqueue_style( 'ryancv-wc-custom', get_template_directory_uri() . '/assets/css/wc-custom.css', array( 'ryancv-style' ), '1.0' );
	}
	if ( $theme_style == 1 ) {
