...
if ( ! class_exists( 'RyanCVAdvancedBackground' ) ) {
	...
	class RyanCVAdvancedBackground {
		...
		public function init_front_assets() {
			...
			if ( $this->theme_bg['type'] == 17 ) {
				...
				.cybergrid-background .cybergrid-top {
					background: -webkit-linear-gradient(left, {$this->theme_bg['cybergrid_color1']}, {$this->theme_bg['cybergrid_color2']} 35%) !important;
					background: linear-gradient(90deg, {$this->theme_bg['cybergrid_color1']}, {$this->theme_bg['cybergrid_color2']} 35%) !important;
				}
				body.body-style-dark .cybergrid-background .cybergrid-top {
					background: -webkit-linear-gradient(top, {$this->theme_bg['cybergrid_color1_dark']}, {$this->theme_bg['cybergrid_color2_dark']}) !important;
					background: linear-gradient(180deg, {$this->theme_bg['cybergrid_color1_dark']}, {$this->theme_bg['cybergrid_color2_dark']}) !important;
				}
			...
			if ( $this->theme_bg['type'] == 19 ) {
				wp_enqueue_style('ryancv-abp-cybergrid-2', RYANCV_ADVANCED_BACKGROUND_URI . 'assets/front/cybergrid/cybergrid.css');
				$custom_css = "
				.cybergrid-background.c-b-2 {
					background: {$this->theme_bg['cybergrid_two_color1']} !important;
				}
				body.body-style-dark .cybergrid-background.c-b-2 {
					background: {$this->theme_bg['cybergrid_two_color1_dark']} !important;
				}
				.cybergrid-background.c-b-2 .cybergrid-bottom {
					background: {$this->theme_bg['cybergrid_two_color2']} !important;
				}
				.cybergrid-background.c-b-2 .cybergrid-bottom .cb-ground:after {
					background: -webkit-linear-gradient(top, {$this->theme_bg['cybergrid_two_color2']}, transparent);
					background: linear-gradient(180deg, {$this->theme_bg['cybergrid_two_color2']}, transparent);
				}
				body.body-style-dark .cybergrid-background.c-b-2 .cybergrid-bottom {
					background: {$this->theme_bg['cybergrid_two_color2_dark']} !important;
				}
				body.body-style-dark .cybergrid-background.c-b-2 .cybergrid-bottom .cb-ground:after {
					background: -webkit-linear-gradient(top, {$this->theme_bg['cybergrid_two_color2_dark']}, transparent);
					background: linear-gradient(180deg, {$this->theme_bg['cybergrid_two_color2_dark']}, transparent);
				}
				.cybergrid-background.c-b-2 .cybergrid-bottom .cb-wave {
					background: {$this->theme_bg['cybergrid_two_color_lines']} !important;
				}
				body.body-style-dark .cybergrid-background.c-b-2 .cybergrid-bottom .cb-wave {
					background: {$this->theme_bg['cybergrid_two_color_lines_dark']} !important;
				}";
			}
			if ( $this->theme_bg['type'] == 20 ) {
				wp_enqueue_script( 'ryancv-abp-ShaderProgram', RYANCV_ADVANCED_BACKGROUND_URI . 'assets/front/digital/ShaderProgram.js', array('jquery'), '1.0.0', true );
				wp_enqueue_script( 'ryancv-abp-snow', RYANCV_ADVANCED_BACKGROUND_URI . 'assets/front/digital/snow.js', array('jquery'), '1.0.0', true );
				$custom_css = "
				body, .canvas.canvas-snow {
					background-color: {$this->theme_bg['snow_bgcolor']} !important;
				}
				body.body-style-dark, body.body-style-dark .canvas.canvas-snow {
					background-color: {$this->theme_bg['snow_bgcolor_dark']} !important;
				}";
			}
			if ( $this->theme_bg['type'] == 21 ) {
				wp_enqueue_style( 'ryancv-abp-abstract', RYANCV_ADVANCED_BACKGROUND_URI . 'assets/front/abstract/abstract.css' );
				wp_enqueue_script( 'ryancv-abp-q5', RYANCV_ADVANCED_BACKGROUND_URI . 'assets/front/abstract/q5.min.js', array('jquery'), '1.0.0', true );
				wp_enqueue_script( 'ryancv-abp-abstract-2-init', RYANCV_ADVANCED_BACKGROUND_URI . 'assets/front/abstract/abstract-2.js', array('jquery'), '1.0.0', true );
				$custom_css = "
				.abstract-background {
					background: {$this->theme_bg['abstract_three_bgcolor']} !important;
				}
				body.body-style-dark .abstract-background {
					background: {$this->theme_bg['abstract_three_bgcolor_d']} !important;
				}";
			}
			if ( $this->theme_bg['type'] == 22 ) {
				wp_enqueue_style( 'ryancv-abp-abstract', RYANCV_ADVANCED_BACKGROUND_URI . 'assets/front/abstract/abstract.css' );
				wp_enqueue_script( 'ryancv-abp-q5', RYANCV_ADVANCED_BACKGROUND_URI . 'assets/front/abstract/q5.min.js', array('jquery'), '1.0.0', true );
				wp_enqueue_script( 'ryancv-abp-abstract-3-init', RYANCV_ADVANCED_BACKGROUND_URI . 'assets/front/abstract/abstract-3.js', array('jquery'), '1.0.0', true );
				$custom_css = "
				.abstract-background {
					background: {$this->theme_bg['abstract_three_bgcolor']} !important;
				}
		...
		public function init_front_html() {
			...
			if ( $this->theme_bg['type'] == 19 ) {
				$html = '<div class="canvas cybergrid-background c-b-2">
			...
			if ( $this->theme_bg['type'] == 20 ) {
				$html = '<div class="canvas canvas-snow" id="canvas_snow"></div>';
			}

			if ( $this->theme_bg['type'] == 21 ) {
				$html = '<div class="canvas abstract-background" id="abstract-bg-js" data-color="' . esc_attr( $this->theme_bg['abstract_three_color'] ) . '"></div>';
			}
