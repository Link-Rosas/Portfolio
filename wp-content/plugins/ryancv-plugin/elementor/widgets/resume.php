...
class RyanCV_Resume_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'timeline',
			[
				'label'       => esc_html__( 'Timeline', 'ryancv-plugin' ),
				'type'        => Controls_Manager::SELECT,
				'default' => 'yes',
				'options' => [
					'no'  => __( 'Hide', 'ryancv-plugin' ),
					'yes' => __( 'Show', 'ryancv-plugin' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .resume-title .name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .resume-title .icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .resume-title .icon' => 'color: {{VALUE}};',
					'.theme-style-dark {{WRAPPER}} .resume-title .icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .styled-gradient .resume-items .resume-item' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .styled-gradient .resume-items .resume-item' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .resume-items .resume-item .date' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'items_date2_color_d',
			[
				'label' => esc_html__( 'Date Active Color (Dark)', 'ryancv-plugin' ),
				'type' => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .resume-items .resume-item.active .date' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .resume-items .resume-item .name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .resume-items .resume-item .company' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .resume-items .resume-item .single-post-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .resume-items .resume-item .single-post-text .lnk' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<!-- resume item -->
		<div class="resume-item<?php if ( $settings['style_ui'] == 'gradient' ) : ?> styled-gradient<?php endif; ?>">
			...
			<div class="resume-items<?php if ( $settings['timeline'] == 'yes' ) : ?> line-timeline<?php endif; ?>">
				...
				<div class="resume-item border-line-h<?php if ( $item['active'] == 'yes' ) : ?> active<?php endif; ?>">
					...
					<div class="image">
						...
						<a <?php if ( $item['button_link'] ) : if ( $item['button_link']['is_external'] ) : ?> target="_blank"<?php endif; ?><?php if ( $item['button_link']['nofollow'] ) : ?> rel="nofollow"<?php endif; ?> href="<?php echo esc_url( $item['button_link']['url'] ); ?>"<?php endif; ?>>
						<?php endif; ?>
