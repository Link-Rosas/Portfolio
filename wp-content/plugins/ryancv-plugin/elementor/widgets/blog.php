...
class RyanCV_Blog_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .styled-gradient .box-item' => 'background: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .styled-gradient .box-item' => 'background: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .blog.blog-style-3 .box-item .desc .date' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .box-item .date' => 'color: {{VALUE}};',
					'.theme-style-dark {{WRAPPER}} .box-item .date' => 'border-color: {{VALUE}};',
					'.theme-style-dark {{WRAPPER}} .blog.blog-style-3 .box-item .desc .date' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'item_date_color_bg',
			[
				'label'     => esc_html__( 'Date BG Color', 'ryancv-plugin' ),
				'type'      => Controls_Manager::COLOR,
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .box-item .date' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .blog.blog-style-3 .box-item .desc .date' => 'background-color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'item_date_color_bg_d',
			[
				'label'     => esc_html__( 'Date BG Color (Dark)', 'ryancv-plugin' ),
				'type'      => Controls_Manager::COLOR,
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .box-item .date' => 'background-color: {{VALUE}};',
					'.theme-style-dark {{WRAPPER}} .blog.blog-style-3 .box-item .desc .date' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .box-item .desc .name, {{WRAPPER}} .blog.blog-style-3 .box-item .desc .name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .box-item .desc .name, .theme-style-dark {{WRAPPER}} .blog.blog-style-3 .box-item .desc .name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .box-item .desc .text' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<!-- Blog -->
		<div class="content works blog-grid blog<?php if ( $settings['style_skin'] == 'style-2' ) : ?> blog-style-2<?php endif; ?><?php if ( $settings['style_skin'] == 'style-3' ) : ?> blog-style-2 blog-style-3<?php endif; ?><?php if ( $settings['style_skin'] == 'style-4' ) : ?> blog-style-2 blog-style-3 blog-style-4<?php endif; ?><?php if ( $settings['style_ui'] == 'gradient' ) : ?> styled-gradient<?php endif; ?><?php if ( $settings['style_ui'] == 'gradient-2' ) : ?> styled-gradient styled-gradient-border<?php endif; ?>">
