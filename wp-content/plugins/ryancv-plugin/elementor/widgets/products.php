	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .woocommerce ul.products li.product .woocommerce-loop-product__title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .woocommerce ul.products li.product .price > span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .woocommerce ul.products li.product .price > span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .woocommerce ul.products li.product .price > span',
			]
		);
	...
	protected function render() {
		...
		<div class="content shops woocommerce">
			...
			<div class="bts bts-center">
				<a class="button"<?php if ( $settings['more_btn_link'] ) : ?> href="<?php echo esc_url( $settings['more_btn_link']['url'] ); ?>"<?php endif; ?><?php if ( $settings['more_btn_link']['is_external'] ) : ?> target="_blank"<?php endif; ?><?php if ( $settings['more_btn_link']['nofollow'] ) : ?> rel="nofollow"<?php endif; ?>>
