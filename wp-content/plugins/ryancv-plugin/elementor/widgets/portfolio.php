...
class RyanCV_Portfolio_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'gradient-2' => __( 'Gradient-2', 'ryancv-plugin' ),
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'style-3' => __( 'Style-3', 'ryancv-plugin' ),
					'style-4' => __( 'Style-4', 'ryancv-plugin' ),
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'columns-2-2'  => __( '2 (2)', 'ryancv-plugin' ),
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .theme-style-dark .styled-gradient .box-item, {{WRAPPER}} .theme-style-dark .styled-gradient.styled-gradient-border .box-item' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .styled-gradient .box-item, .theme-style-dark {{WRAPPER}} .styled-gradient.styled-gradient-border .box-item' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .box-item .image .info .icon' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .box-item .desc .name, {{WRAPPER}} .works.works-style-3 .box-item .desc .name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .box-item .desc .name, .theme-style-dark {{WRAPPER}} .works.works-style-3 .box-item .desc .name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .box-item .desc .name, {{WRAPPER}} .works.works-style-3 .box-item .desc .name',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .box-item .desc .category, {{WRAPPER}} .works.works-style-3 .box-item .desc .category' => 'color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'item_category_color_d',
			[
				'label'     => esc_html__( 'Category Color (Dark)', 'ryancv-plugin' ),
				'type'      => Controls_Manager::COLOR,
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .box-item .desc .category, .theme-style-dark {{WRAPPER}} .works.works-style-3 .box-item .desc .category' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .box-item .desc .category, {{WRAPPER}} .works.works-style-3 .box-item .desc .category',
			]
		);

		$this->add_control(
			'item_category_color_bg',
			[
				'label'     => esc_html__( 'Category BG Color', 'ryancv-plugin' ),
				'type'      => Controls_Manager::COLOR,
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .works.works-style-3 .box-item .desc .category' => 'background-color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'item_category_color_bg_d',
			[
				'label'     => esc_html__( 'Category BG Color (Dark)', 'ryancv-plugin' ),
				'type'      => Controls_Manager::COLOR,
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .works.works-style-3 .box-item .desc .category' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<!-- Works -->
		<div class="content works-grid works <?php if ( $settings['layout'] == 2 ) : ?> works-minimal<?php endif; ?><?php if ( $settings['style_skin'] == 'style-2' ) : ?> works-style-2<?php endif; ?><?php if ( $settings['style_skin'] == 'style-3' ) : ?> works-style-2 works-style-3<?php endif; ?><?php if ( $settings['style_skin'] == 'style-4' ) : ?> works-style-2 works-style-3 works-style-4<?php endif; ?><?php if ( $settings['style_ui'] == 'gradient' ) : ?> styled-gradient<?php endif; ?><?php if ( $settings['style_ui'] == 'gradient-2' ) : ?> styled-gradient styled-gradient-border<?php endif; ?>">
			...
			<?php if ( $settings['pagination'] == 'scroll' ) :
				$infinite_scrolling_data = array(
					...
					'ajax_nonce' => wp_create_nonce( 'ryancv_ajax' ),
