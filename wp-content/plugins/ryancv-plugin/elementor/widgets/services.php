...
class RyanCV_Services_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .service-items .service-item .name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .service-items .service-item .desc' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<!-- Services -->
		<div class="content services<?php if ( $settings['style_ui'] == 'gradient' ) : ?> styled-gradient<?php endif; ?>">
			...
			<div class="row service-items border-line-v">
				...
				<div class="col col-d-6 col-t-6 col-m-12 border-line-h">
					<div class="service-item<?php if ( $settings['align'] == 'left' ) : ?> align-left<?php endif; ?>">
						<?php if( $item['icon'] ) : ?>
