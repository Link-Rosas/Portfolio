...
class RyanCV_Pricing_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .styled-gradient .pricing-items .pricing-item' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .styled-gradient .pricing-items .pricing-item' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .pricing-items .pricing-item .icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .pricing-items .pricing-item .icon' => 'color: {{VALUE}};',
					'.theme-style-dark {{WRAPPER}} .pricing-items .pricing-item .icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .pricing-items .pricing-item .name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .pricing-items .pricing-item .amount .dollar, .theme-style-dark {{WRAPPER}} .pricing-items .pricing-item .amount .number' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label'     => esc_html__( 'Price Secondary Color (Dark)', 'ryancv-plugin' ),
				'type'      => Controls_Manager::COLOR,
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .pricing-items .pricing-item .amount .period' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pricing-items .pricing-item .amount .period',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .pricing-items .pricing-item .feature-list' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<!-- Price Tables -->
		<div class="content pricing<?php if ( $settings['style_ui'] == 'gradient' ) : ?> styled-gradient<?php endif; ?>">
