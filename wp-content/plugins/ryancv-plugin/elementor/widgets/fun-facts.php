	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .fuct-items .fuct-item .icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .fuct-items .fuct-item .icon' => 'color: {{VALUE}};',
					'.theme-style-dark {{WRAPPER}} .fuct-items .fuct-item .icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'items_icon_bg_d',
			[
				'label' => esc_html__( 'Icon Background (Dark)', 'ryancv-plugin' ),
				'type' => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .fuct-items .fuct-item .icon' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .fuct-items .fuct-item .name' => 'color: {{VALUE}};',
				],
			]
		);
