 ...
 * @since 1.0
 */
class RyanCV_Clients_Two_Widget extends Widget_Base {

	public function get_name() {
		return 'ryancv-clients-carousel';
	}

	public function get_title() {
		return esc_html__( 'Clients (Carousel)', 'ryancv-plugin' );
	}
	...
	protected function render() {
		...
		<div class="content clients">
            ...
            <div class="swiper-container clients-infinite client-items">
...
Plugin::instance()->widgets_manager->register( new RyanCV_Clients_Two_Widget() );