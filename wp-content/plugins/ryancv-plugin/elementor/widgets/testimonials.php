	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .revs-item .text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .revs-item .info .name' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'.theme-style-dark {{WRAPPER}} .revs-item .info .company' => 'color: {{VALUE}};',
				],
			]
		);
						...
						<div class="swiper-container" data-swiper-autoplay="<?php echo esc_attr( $settings['is_autoplay'] ); ?>" data-swiper-delay="<?php echo esc_attr( $settings['is_autoplaytime'] ); ?>" data-swiper-loop="<?php echo esc_attr( $settings['is_loop'] ); ?>">
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<div class="revs-item<?php if ( $settings['align'] == 'left' ) : ?> align-left<?php endif; ?>">
										<?php if ( $item['text'] ) : ?>
										<div class="text">
										...
										<div class="user">
											<?php if( $item['image']['id'] ) :
												$image = wp_get_attachment_image_url( $item['image']['id'], 'ryancv_280x280' );
											?>
											<div class="img">
