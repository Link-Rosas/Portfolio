  ...
  public $slug = 'ryancv';
    ...
    function activated_form_content(){
        ...
        <div class="ryancv-dashboard-activation">
          ...
          <p style="margin-top: 30px;"><strong><?php echo sprintf( __( 'Manage Your License', 'ryancv-plugin' ) ); ?></strong></p>
          <div class="notice notice-info">
            <p><?php echo sprintf( __( 'To manage all your activation, please, register an account and login on <a href="https://licenses.bslthemes.com/" target="_blank">Bslthemes License Manager</a> using your already registered email and purchase code.', 'ryancv-plugin' ) ); ?></p>
          </div>
        </div>
    <?php
    }
